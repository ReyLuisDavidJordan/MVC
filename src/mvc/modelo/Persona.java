...
public class Persona {
    ...
    public Persona(String idPersona, String nombrePersona, String apellidoPersona, Date fechanacimineto, String telefono, String sexo, double sueldo, int cupo, String foto, String correo) {
